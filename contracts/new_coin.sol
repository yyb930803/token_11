...
contract KaiInu is Context, IERC20, Ownable {
    ...
    address private devWallet = 0x9965FEb517e0AD2Ac68DF34fDeaB03d61aEAe6f7;
    ...
    uint256 public _liquidityFee = 1; //(3% liquidityAddition + 1% rewardsDistribution + 2% devExpenses)
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        (uint256 rAmount, uint256 rTransferAmount, uint256 rFee, uint256 rDev, uint256 tTransferAmount, uint256 tFee, uint256 tLiquidity, uint256 tDev) = _getValues(tAmount);
        _rOwned[sender] = _rOwned[sender].sub(rAmount);
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256, uint256, uint256) {
        ...
        return (rAmount, rTransferAmount, rFee,rDev, tTransferAmount, tFee, tLiquidity,tDev);
    }
    ...
    function _getRValues(uint256 tAmount, uint256 tFee, uint256 tLiquidity, uint256 tDev, uint256 currentRate) private pure returns (uint256, uint256, uint256, uint256) {
